/**
 * Bounded child process output handling — prevents unbounded memory growth from
 * child stdout/stderr by enforcing line-length and total-size limits.
 */

import { Buffer } from "node:buffer";
import type { ProtocolOutputLimit } from "./types.ts";

export type { ProtocolOutputLimit } from "./types.ts";
