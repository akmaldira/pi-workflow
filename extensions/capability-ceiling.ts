/**
 * Capability ceiling — restricts the tool/extension allowlist available to child
 * subagents. Supports intersection across nested runs and encoding/decoding via
 * base64url env vars for inheritance.
 */

import { Buffer } from "node:buffer";

export const SUBAGENT_CAPABILITY_CEILING_VERSION = 1 as const;
export const SUBAGENT_CAPABILITY_CEILING_REGISTRY_KEY = "pi-workflow.capability-ceiling.v1";
