/**
 * Pi CLI spawn command resolution
 *
 * Resolves the correct command to spawn a child pi process, supporting:
 * - PI_SUBAGENT_PI_BINARY env var override
 * - Current script resolution (process.argv[1])
...
export const PI_CODING_AGENT_PACKAGE_ROOT_ENV = "PI_CODING_AGENT_PACKAGE_ROOT";
